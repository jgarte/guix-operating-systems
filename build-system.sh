...
#config=custom-system.scm
#{
#  guix system build --fallback --system=armhf-linux --root=system.build $config || fail
#}
#  { image_location=$(guix system disk-image --system=armhf-linux --save-provenance -t arm $config)
#    if test -n "$image_location"
#    then
#      echo copying...
